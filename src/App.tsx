...
// ==========================================
// 1. إعدادات Firebase الثابتة والمتوافقة بالكامل لمنع انفصال الاتصال
// ==========================================
...
// معرّف التطبيق الثابت والموحد لضمان قراءة وكتابة البيانات في نفس المسار دائماً
          ...
          {data.map((item, idx) => {
            ...
            return (
              <g key={idx} className="group font-sans">
                ...
                />
                <g className="opacity-0 group-hover:opacity-100 transition-opacity duration-200 font-sans font-sans font-sans">
                  <rect 
                    x={x - 10} 
                    y={y - 25} 
                    width="44" 
  ...
  return (
    <div className={`min-h-screen transition-all pb-24 ${darkMode ? 'bg-slate-950 text-white' : 'bg-[#fcfdfe] text-slate-900'} ${subjectConfig.global_style === 'rounded-none' ? 'rounded-none' : subjectConfig.global_style === 'rounded-3xl' ? 'rounded-3xl' : 'rounded-fabulous'}`} dir="rtl">
      ...
      {role === 'student' && user?.status === 'blocked' && (
        <div className="fixed inset-0 z-[1000] bg-slate-950/95 backdrop-blur-md flex items-center justify-center p-6 text-center font-sans font-sans">
        ...
        <div className={`min-h-screen flex items-center justify-center p-6 ${darkMode ? 'bg-slate-950 text-white' : 'bg-[#f8fafc] text-slate-900'}`} dir="rtl">
          <div className={`max-w-md w-full p-10 rounded-[3rem] shadow-2xl ${darkMode ? 'bg-slate-900' : 'bg-white border border-slate-100'}`}>
            <div className="text-center mb-8">
              ...
              <h1 className="text-3xl font-black italic text-slate-800 font-sans font-sans font-sans font-sans">مَنصة التميز.</h1>
            </div>
                  ...
                  {gradeYears.length > 0 && (
                     <div className="space-y-1.5 animate-in slide-in-from-top-3">
                        ...
                        <select 
                           ...
                           className="w-full p-4 rounded-2xl bg-slate-50 dark:bg-slate-800 font-bold text-center border-2 border-transparent focus:border-blue-500 cursor-pointer outline-none font-sans font-sans font-sans font-sans font-sans"
                        >
      ...
      {user && (
        <>
          ...
          <header className={`sticky top-0 z-50 px-6 py-4 flex items-center justify-between border-b backdrop-blur-xl ${darkMode ? 'bg-slate-900/80 border-slate-800' : 'bg-white/80 border-slate-100'}`}>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="hidden sm:flex items-center gap-3 px-4 py-2 bg-slate-100 dark:bg-slate-800 rounded-2xl font-sans">
                ...
                <div className="text-right leading-none font-sans">
                  <span className="font-bold text-sm block font-sans font-sans font-sans font-sans">{user.name}</span>
                  {role === 'student' && <span className={`block text-[9px] font-black mt-1 font-sans ${activeSubjectId === 'chemistry' ? (subjectConfig.chemistry_theme === 'red' ? 'text-red-600' : subjectConfig.chemistry_theme === 'emerald' ? 'text-emerald-600' : subjectConfig.chemistry_theme === 'purple' ? 'text-purple-600' : subjectConfig.chemistry_theme === 'amber' ? 'text-amber-500' : 'text-blue-600') : (subjectConfig.physics_theme === 'red' ? 'text-red-600' : subjectConfig.physics_theme === 'emerald' ? 'text-emerald-600' : subjectConfig.physics_theme === 'purple' ? 'text-purple-600' : subjectConfig.physics_theme === 'amber' ? 'text-amber-500' : 'text-blue-600')}`}>{user.studentId}</span>}
                </div>
              </div>
            </div>
          </header>
          ...
          <div className="max-w-7xl mx-auto px-6 pt-6 sm:px-10">
             <div className="bg-white dark:bg-slate-900 p-4 rounded-[2rem] border shadow-sm flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="flex flex-col sm:flex-row items-center gap-4 w-full md:w-auto font-sans">
                   <span className="font-black text-sm text-slate-400 flex items-center gap-2 flex-row-reverse text-right whitespace-nowrap font-sans font-sans font-sans">
                ...
                {role === 'teacher' && gradeYears.length > 0 && (
                   <div className="flex items-center gap-3 w-full md:w-auto justify-end flex-row-reverse font-sans font-sans">
                      ...
                      <select
                        ...
                        className="p-3 bg-slate-50 dark:bg-slate-800 border-2 border-transparent focus:border-blue-500 rounded-2xl font-black text-sm outline-none cursor-pointer text-right w-full sm:w-56 font-sans font-sans font-sans font-sans font-sans font-sans font-sans font-sans"
                      >
          ...
          <main className="max-w-7xl mx-auto p-6 sm:p-10">
            ...
            {/* تنبيه خمول الطالب الفوري والبارز داخل الصفحة الرئيسية للطالب تحت البند المطلوب */}
            {role === 'student' && activeTab === 'الرئيسية' && unopenedCount >= 3 && (
              <div className="mb-6 p-6 bg-red-50 dark:bg-red-950/20 border-r-4 border-red-600 rounded-[2rem] flex items-center gap-4 text-right justify-between flex-row-reverse shadow-md animate-pulse">
                <div className="flex items-center gap-3 flex-row-reverse text-right">
                  <ShieldAlert className="text-red-600 shrink-0" size={32} />
                  <div>
                    <h4 className="font-black text-red-600 text-lg">تحذير تراكم متأخرات المذاكرة! ⚠️</h4>
                    <p className="text-xs text-red-500 font-bold mt-1">
                      أهلاً بك. نلاحظ متأخرات مذاكرة لديك بمعدل <span className="underline font-black text-sm">{unopenedCount}</span> عناصر منشورة لم تفتحها أو تحلها حتى الآن. يرجى البدء بمشاهدة الدروس فوراً لتقليل المتراكم عليك إلى ما هو أقل من 3 متأخرات لتجنب التنبيه الدائم وحفظ أدائك الدراسي.
                    </p>
                  </div>
                </div>
              </div>
            ...
            {activeTab === 'الرئيسية' && (
              <div className="space-y-8 animate-in fade-in">
                ...
                <div className={`bg-gradient-to-br ${activeSubject.bgGradient} p-10 sm:p-16 rounded-[3.5rem] text-white shadow-2xl relative overflow-hidden group transition-all duration-500`}>
                   ...
                   <h2 className="text-3xl sm:text-5xl font-black mb-4 relative z-10 italic font-sans font-sans">مادة {activeSubject.name} 📚</h2>
                ...
                {role === 'teacher' && (
                  <div className="space-y-8 pt-6 animate-in slide-in-from-bottom-4 duration-500">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 font-sans font-sans">
                      ...
                      <div>
                        {teacherChartData.length > 0 ? (
                          ...
                          <div className="bg-white dark:bg-slate-900 p-8 rounded-[2rem] border text-center opacity-30 italic font-black font-sans">
                      ...
                      <div className="bg-white dark:bg-slate-900 p-6 rounded-[2rem] border dark:border-slate-800 shadow-sm text-right flex flex-col justify-between font-sans">
                         <div>
                            ...
                            <div className="space-y-3 max-h-[220px] overflow-y-auto pr-2">
                               {filteredContents.length > 0 ? [...filteredContents].reverse().slice(0, 4).map((item, i) => (
                                 <div key={i} className="p-3 bg-slate-50 dark:bg-slate-800 border dark:border-slate-800 rounded-xl flex justify-between items-center flex-row-reverse text-xs font-bold font-sans font-sans font-sans font-sans font-sans font-sans font-sans font-sans font-sans">
                         ...
                         <button type="button" onClick={() => setShowContentsList(true)} className={`w-full text-white py-3.5 mt-4 rounded-xl font-bold text-xs flex justify-center items-center gap-1.5 transition-all hover:brightness-105 active:scale-95 ${activeSubject.accentColor} font-sans`}>
                    ...
                    <div className="bg-white dark:bg-slate-900 p-8 rounded-[3rem] border dark:border-slate-800 overflow-hidden flex flex-col font-sans">
                       ...
                       <div className="overflow-y-auto max-h-[300px] space-y-3 pr-2 font-sans font-sans font-sans">
                          {filteredViewLogs.length > 0 ? [...filteredViewLogs].reverse().map((log, i) => (
                            <div key={i} className="p-4 bg-slate-50 dark:bg-slate-800 border dark:border-slate-800 rounded-2xl flex items-center justify-between text-sm shadow-sm flex-row-reverse font-sans font-sans font-sans font-sans font-sans">
                               <div className="flex items-center gap-3 flex-row-reverse text-right">
                            ...
                            <p className="text-center opacity-40 py-12 italic font-black font-sans font-sans font-sans">لا توجد سجلات نشاط لطلب الكيمياء أو الفيزياء بعد.</p>
                          )}
                       </div>
                    </div>
                  </div>
            ...
            {activeTab === 'التحليلات' && (
              <div className="space-y-8 animate-in slide-in-from-bottom-4 duration-500 text-right">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                   <div className="lg:col-span-1 bg-white p-8 rounded-[3rem] border dark:border-slate-800 flex flex-col justify-between font-sans">
                      <div>
                        ...
                        <div className="space-y-4">
                           <div className="p-6 bg-green-50 dark:bg-green-950/20 rounded-3xl flex justify-between items-center font-sans">
                   ...
                   <div className="lg:col-span-2 font-sans font-sans font-sans">
                     {role === 'teacher' ? (
                       teacherChartData.length > 0 ? (
                           ...
                           {filteredViewLogs.length > 0 ? [...filteredViewLogs].reverse().map((log, i) => (
                             <div key={i} className="p-4 bg-slate-50 dark:bg-slate-800 border dark:border-slate-800 rounded-2xl flex items-center justify-between text-sm shadow-sm flex-row-reverse font-sans font-sans font-sans">
                                ...
                                <div className="text-left">
                                   ...
                                   <p className="text-[9px] opacity-40 font-bold font-sans font-sans font-sans font-sans font-sans font-sans font-sans font-sans">{log.timestamp?.toDate().toLocaleString('ar-EG')}</p>
                                </div>
                             </div>
               ...
               <div className="animate-in fade-in">
                  {activeTab === 'إضافة دروس' ? (
                    <div className="max-w-3xl mx-auto p-10 bg-white dark:bg-slate-900 rounded-[3.5rem] shadow-2xl border dark:border-slate-800 text-right animate-in fade-in">
                      ...
                      {fileError && <div className="p-4 mb-4 bg-red-100 text-red-700 rounded-xl text-center font-bold font-sans font-sans font-sans font-sans font-sans font-sans font-sans font-sans font-sans">{fileError}</div>}
                      ...
                      <form onSubmit={handleAddContent} className="space-y-6">
                        ...
                        <div>
                          ...
                          <select 
                            ...
                            className="w-full p-5 rounded-2xl bg-slate-50 dark:bg-slate-800 font-bold text-center border-2 border-transparent focus:border-blue-500 cursor-pointer font-sans font-sans"
                          >
                        ...
                        {contentType !== 'material' ? (
                          <div className="space-y-4 animate-in fade-in">
                            ...
                            <div className="flex bg-slate-100 dark:bg-slate-800 p-1.5 rounded-2xl font-sans font-sans">
                              <button 
                                type="button" 
                                onClick={() => setUploadType('link')} 
                                className={`flex-1 py-3 text-center rounded-xl font-bold transition-all text-sm ${uploadType === 'link' ? 'bg-white dark:bg-slate-700 shadow-sm' : 'opacity-50'} font-sans font-sans font-sans font-sans`}
                              >
                                وضع رابط URL
                              </button>
                              <button 
                                ...
                                className={`flex-1 py-3 text-center rounded-xl font-bold transition-all text-sm ${uploadType === 'file' ? 'bg-white dark:bg-slate-700 shadow-sm' : 'opacity-50'} font-sans font-sans`}
                              >
                                رفع فيديو من جهازي
                              </button>
                            </div>
                            ...
                            {uploadType === 'link' ? (
                              <div className="space-y-2 animate-in fade-in">
                                ...
                                <input name="url" required={uploadType === 'link'} className="w-full p-5 rounded-2xl bg-slate-50 dark:bg-slate-800 font-bold outline-none border-2 border-transparent focus:border-blue-500 text-center font-sans font-sans font-sans font-sans font-sans font-sans" placeholder="الصق الرابط المباشر هنا" />
                              </div>
                            ) : (
                              <div className="space-y-4 animate-in fade-in">
                                <label className="text-xs font-bold text-slate-400 block mb-1">اختر ملف الفيديو من جيل الهاتف:</label>
                                <input type="file" accept="video/*" onChange={handleFileChange} required={uploadType === 'file'} className="w-full p-4 border rounded-2xl bg-slate-50 dark:bg-slate-800 font-bold font-sans font-sans" />
                                {loading && (
                                  <div className="space-y-2">
                                    <div className="w-full h-3 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden">
                                      <div className="h-full bg-blue-600 transition-all duration-300" style={{ width: `${uploadProgress}%` }}></div>
                                    </div>
                                    <p className="text-center text-xs font-bold text-blue-600 animate-pulse">جاري رفع ومعالجة الفيديو سحابياً... {uploadProgress}%</p>
                                  </div>
                                )}
                              </div>
                            )}
                          ...
                          <div className="space-y-2 animate-in fade-in">
                            <label className="text-xs font-bold text-slate-400 block mb-1 font-sans">الرابط المباشر لملف المذكرة (PDF الرابط فقط):</label>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text-right font-sans font-sans font-sans">
                          ...
                          <div key={item.id} className="bg-white dark:bg-slate-900 p-6 rounded-[2.5rem] border dark:border-slate-800 shadow-sm hover:shadow-xl transition-all group overflow-hidden text-right relative font-sans font-sans font-sans">
                             {locked && (
                               <div className="absolute inset-0 z-10 bg-slate-950/80 backdrop-blur-sm flex flex-col items-center justify-center p-6 text-center text-white font-sans font-sans">
                                  ...
                                  <p className="text-[10px] text-slate-400 font-bold leading-relaxed max-w-[200px] font-sans">يجب الاشتراك لتفعيل هذا المحتوى</p>
                               </div>
                             )}
                             ...
                             <div className="flex gap-3">
                                ...
                                <a href={item.url} target="_blank" rel="noreferrer" className="p-4 border dark:border-slate-800 rounded-2xl hover:bg-slate-100 dark:hover:bg-slate-800 transition-all font-sans font-sans"><Download size={20}/></a>
                             </div>
                          </div>
                        );
                      })}
                      {filteredContents.filter(c => c.type === (activeTab === 'الفيديوهات' ? 'video' : 'material')).length === 0 && (
                        <div className="col-span-3 text-center py-20 bg-white dark:bg-slate-900 border dark:border-slate-800 rounded-[2.5rem] opacity-40 w-full font-sans font-sans">
                 ...
                 {activeQuiz ? (
                   <div className="bg-white dark:bg-slate-900 p-8 rounded-[3rem] border dark:border-slate-800 shadow-xl max-w-3xl mx-auto font-sans font-sans">
                     <div className="flex items-center justify-between border-b dark:border-slate-800 pb-4 mb-6 flex-row-reverse">
                        ...
                        <div className="flex items-center gap-2 text-red-500 font-black font-sans font-sans">
                           <Clock size={18}/>
                           <span className="font-sans font-sans">{Math.floor(quizTimer / 60)}:{(quizTimer % 60).toString().padStart(2, '0')}</span>
                        </div>
                     </div>
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 font-sans">
                      {filteredQuizzes.map((quiz, index) => {
                        ...
                        return (
                          <div key={quiz.id} className="bg-white dark:bg-slate-900 p-6 rounded-[2.5rem] border dark:border-slate-800 shadow-sm flex flex-col justify-between relative overflow-hidden font-sans font-sans font-sans">
                             {locked && (
                               <div className="absolute inset-0 z-10 bg-slate-950/80 backdrop-blur-sm flex flex-col items-center justify-center p-6 text-center text-white font-sans">
                                  ...
                                  <p className="text-[10px] text-slate-400 font-bold leading-relaxed max-w-[200px] font-sans font-sans">يجب الاشتراك لتفعيل هذا الاختبار</p>
                               </div>
                             )}
                             <div>
                               <div className="flex items-center justify-between mb-2 flex-row-reverse font-sans">
                                 <h4 className="font-black text-lg font-sans font-sans font-sans">{quiz.title}</h4>
                               ...
                               {quiz.gradeYear && <span className="block text-center text-xs text-blue-500 font-black mb-4 bg-blue-50 dark:bg-blue-950/20 py-1.5 rounded-xl font-sans">الصف الدراسي: {quiz.gradeYear}</span>}
                             </div>
                             {hasDone ? (
                               <div className="space-y-3 font-sans font-sans">
                                 <div className="p-3 bg-green-50 dark:bg-green-950/20 text-green-600 rounded-2xl text-center font-black text-sm font-sans font-sans font-sans">
                               ...
                               <button 
                                 ...
                                 className={`w-full text-white py-3 rounded-2xl font-black text-sm transition-all flex items-center justify-center gap-1 ${activeSubject.accentColor}`}
                               >
            ...
            {activeTab === 'إنشاء اختبار' && role === 'teacher' && (
              <div className="max-w-3xl mx-auto p-10 bg-white dark:bg-slate-900 rounded-[3.5rem] shadow-2xl border dark:border-slate-800 text-right animate-in fade-in">
                 <h3 className="text-3xl font-black text-center mb-2 italic text-slate-800 dark:text-slate-100 font-sans">إنشاء اختبار جديد</h3>
                 ...
                 {successMessage && <div className="p-4 mb-4 bg-green-100 text-green-700 rounded-xl text-center font-bold font-sans font-sans font-sans font-sans">{successMessage}</div>}
                 {fileError && <div className="p-4 mb-4 bg-red-100 text-red-700 rounded-xl text-center font-bold font-sans font-sans font-sans">{fileError}</div>}
                 
                 <div className="space-y-6">
                    <div className="flex bg-slate-100 dark:bg-slate-800 p-1.5 rounded-2xl font-sans">
                    ...
                    <div>
                      <label className="block text-sm font-bold text-slate-400 mb-2 font-sans font-sans">عنوان الاختبار:</label>
                      <input 
                        type="text" 
                        value={newQuizTitle} 
                    ...
                    {gradeYears.length > 0 && (
                      <div className="space-y-2 animate-in fade-in font-sans font-sans">
                        <label className="block text-sm font-bold text-slate-400 mb-2 font-sans">الصف الدراسي المستهدف للامتحان:</label>
                        <select 
                          value={newQuizGradeYear} 
                          onChange={(e) => setNewQuizGradeYear(e.target.value)} 
                          className="w-full p-5 rounded-2xl bg-slate-50 dark:bg-slate-800 font-bold text-center border-2 border-transparent focus:border-blue-500 cursor-pointer outline-none"
                        >
                    ...
                    {isGoogleForm ? (
                      <div className="space-y-2 animate-in fade-in">
                        <label className="block text-sm font-bold text-slate-400 mb-2 font-sans">رابط الـ Google Form الخاص بالاختبار:</label>
                        <input 
                          type="text" 
                          value={googleFormUrl} 
                          onChange={(e) => setGoogleFormUrl(e.target.value)} 
                          className="w-full p-4 rounded-xl bg-slate-50 dark:bg-slate-800 border-none outline-none font-bold text-center font-sans font-sans font-sans" 
                  ...
                  <div className="border-t dark:border-slate-800 pt-6 space-y-4 animate-in fade-in font-sans">
                     ...
                     <input 
                       ...
                       className="w-full p-4 rounded-xl bg-slate-50 dark:bg-slate-800 border-none outline-none font-bold font-sans" 
        ...
        {activeTab === 'إدارة الصفوف' && role === 'teacher' && (
          <div className="max-w-4xl mx-auto p-8 bg-white dark:bg-slate-900 rounded-[3.5rem] shadow-2xl border dark:border-slate-800 text-right animate-in fade-in">
             <div className="flex items-center gap-3 flex-row-reverse mb-6 border-b pb-4 font-sans font-sans font-sans font-sans">
                <Layers className="text-blue-600" size={32}/>
                <div>
                   <h3 className="text-3xl font-black italic text-slate-800 dark:text-slate-100 font-sans font-sans">إدارة الصفوف والسنين الدراسية</h3>
             ...
             {fileError && <div className="p-4 mb-4 bg-red-100 text-red-700 rounded-xl text-center font-bold font-sans font-sans font-sans font-sans">{fileError}</div>}

             <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {/* فورم الإضافة والتعديل */}
                <div className="md:col-span-1 p-6 bg-slate-50 dark:bg-slate-800/40 rounded-3xl border dark:border-slate-800 h-fit font-sans font-sans font-sans">
                   ...
                   <form onSubmit={handleSaveGradeYear} className="space-y-4">
                      <div>
                         ...
                         <input 
                           ...
                           className="w-full p-3.5 rounded-2xl bg-white dark:bg-slate-900 font-bold border outline-none focus:border-blue-500 text-sm font-sans font-sans font-sans" 
                         />
                      </div>
                      <div>
                         ...
                         <select 
                           ...
                           className="w-full p-3.5 rounded-2xl bg-white dark:bg-slate-900 font-bold border outline-none cursor-pointer text-sm font-sans"
                         >
                      ...
                      <div className="flex gap-2 pt-2">
                         <button disabled={loading} type="submit" className="flex-1 bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-xl font-bold text-xs transition-all">
                         ...
                         {editingGrade && (
                            <button 
                              ...
                              className="bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-white px-3 py-3 rounded-xl font-bold text-xs transition-all font-sans font-sans font-sans font-sans"
                            >
                               إلغاء
                            </button>
                         )}
                ...
                <div className="md:col-span-2 space-y-4 font-sans font-sans">
                   <h4 className="font-black text-lg text-slate-700 dark:text-slate-200">الصفوف الدراسية الفعالة بالمنصة حالياً ({gradeYears.length}):</h4>
                   {gradeYears.length > 0 ? (
                         ...
                         {gradeYears.map((grade) => (
                           <div key={grade.id} className="p-5 bg-white dark:bg-slate-900 border dark:border-slate-800 rounded-3xl flex items-center justify-between flex-row-reverse shadow-sm">
                              ...
                              <div className="flex gap-2">
                                 ...
                                 <button type="button" onClick={() => handleDeleteGrade(grade.id)} className="px-3 py-1.5 bg-red-50 hover:bg-red-100 text-red-600 rounded-xl text-xs font-black transition-all">🗑️ حذف</button>
                              </div>
                           </div>
                         ))}
                      </div>
                      ...
                      <div className="text-center py-16 opacity-30 italic font-black">
                         <Info size={40} className="mx-auto mb-2 font-sans font-sans font-sans" />
        ...
        {activeTab === 'إدارة الطلاب' && role === 'teacher' && (
          <div className="space-y-8 text-right animate-in fade-in">
             ...
             <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 bg-white dark:bg-slate-900 p-8 rounded-[3rem] border dark:border-slate-800 shadow-sm min-h-[300px] flex flex-col justify-between font-sans animate-in fade-in font-sans">
                   {scannedStudent ? (
                     <div className="space-y-6 animate-in fade-in">
                        <div className="flex items-center justify-between border-b pb-4 flex-row-reverse font-sans">
                           <div className="text-right">
                              ...
                              {scannedStudent.gradeYear && <p className="text-xs text-blue-600 font-black mt-1 font-sans font-sans">الصف الدراسي: {scannedStudent.gradeYear}</p>}
                           </div>
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm font-sans font-sans font-sans">
                        ...
                        <div className="pt-4 border-t dark:border-slate-800 space-y-3 font-sans font-sans font-sans font-sans">
                     ...
                     <div className="h-full flex flex-col items-center justify-center text-slate-400 font-bold italic py-20 text-center animate-pulse font-sans">
          ...
          <div className="max-w-4xl mx-auto py-10 text-right animate-in fade-in">
             ...
             {role === 'teacher' ? (
                <form onSubmit={handleSaveThemesAndNames} className="bg-white p-8 sm:p-12 rounded-[3.5rem] border shadow-xl space-y-8 font-sans">
                   <div className="grid grid-cols-1 md:grid-cols-2 gap-8 font-sans font-sans">
                      {/* المادة الأولى */}
                      <div className="space-y-4 p-6 bg-slate-50 dark:bg-slate-800/40 rounded-3xl border dark:border-slate-800 font-sans">
                         ...
                         <div>
                            ...
                            <input name="chem_name" required defaultValue={subjectConfig.chemistry_name} className="w-full p-4 rounded-2xl bg-white dark:bg-slate-900 font-bold border outline-none focus:border-red-500 font-sans" />
                         </div>
                         <div>
                      ...
                      {/* المادة الثانية */}
                      <div className="space-y-4 p-6 bg-slate-50 dark:bg-slate-800/40 rounded-3xl border dark:border-slate-800 font-sans">
                         <h4 className="font-black text-lg text-blue-600 flex items-center gap-2 flex-row-reverse font-sans">تخصيص المادة الثانية <BookOpen size={18}/></h4>
                         <div>
                         ...
                         <div>
                            ...
                            <select name="phys_theme" defaultValue={subjectConfig.physics_theme} className="w-full p-4 rounded-2xl bg-white dark:bg-slate-900 font-bold border cursor-pointer font-sans font-sans">
                               <option value="blue">🔵 الأزرق القياسي</option>
                               <option value="red">🔴 الأحمر الملكي</option>
                               <option value="emerald">🟢 الأخضر الزمردي</option>
                               <option value="purple">🟣 البنفسجي الأنيق</option>
                      ...
                      <div className="md:col-span-2 space-y-4 p-6 bg-slate-50 dark:bg-slate-800/40 rounded-3xl border dark:border-slate-800 font-sans">
                         <h4 className="font-black text-lg text-blue-600 flex items-center gap-2 flex-row-reverse font-sans font-sans font-sans">حماية وتأمين الـ OneSignal REST API KEY <Lock size={18}/></h4>
                         <div>
                            <label className="text-xs font-black text-slate-400 block mb-1">أدخل مفتاح الـ REST API KEY الحساس الخاص بك:</label>
                            <input name="onesignal_rest_key" type="password" defaultValue={subjectConfig.onesignal_rest_key || ""} placeholder="يتم تخزينه في الـ Database بعيداً عن الكود" className="w-full p-4 rounded-2xl bg-white dark:bg-slate-900 font-bold border outline-none focus:border-blue-500 font-mono font-sans font-sans" />
                         </div>
                      </div>
                   </div>
                ...
                <div className="text-center p-20 bg-white font-sans animate-in fade-in font-sans">
      ...
      {showStudentsList && role === 'teacher' && (
        <div className="fixed inset-0 z-[400] flex items-center justify-center p-4 bg-slate-900/80 backdrop-blur-md animate-in fade-in" onClick={() => { setShowStudentsList(false); setSelectedStudentForLogs(null); }}>
           <div className="relative w-full max-w-4xl bg-white rounded-[3rem] shadow-2xl overflow-hidden max-h-[85vh] flex flex-col md:flex-row-reverse font-sans" onClick={e => e.stopPropagation()}>
              ...
              <div className="flex-[1.5] bg-slate-50 p-8 overflow-y-auto text-right animate-in fade-in font-sans font-sans font-sans">
                 {selectedStudentForLogs ? (
                    <>
                          ...
                          {filteredResults.filter(r => r.studentName === selectedStudentForLogs.username).length > 0 ? (
                            <div className="space-y-2">
                               {filteredResults.filter(r => r.studentName === selectedStudentForLogs.username).map((res, i) => (
                                 <div key={i} className="p-3 bg-slate-50 dark:bg-slate-800 rounded-xl flex items-center justify-between text-xs font-bold font-sans">
                       ...
                       <div className="space-y-3 font-sans">
                          <h5 className="font-black text-sm font-sans">سجل مشاهدة محاضرات مادة {activeSubject.name}:</h5>
                          {filteredViewLogs.filter(l => l.studentName === selectedStudentForLogs.username).length > 0 ? 
                            [...filteredViewLogs.filter(l => l.studentName === selectedStudentForLogs.username)].reverse().map((log, i) => (
                              <div key={i} className="bg-white p-4 rounded-2xl text-sm shadow-sm border dark:border-slate-800">
      ...
      {showContentsList && role === 'teacher' && (
        <div className="fixed inset-0 z-[400] flex items-center justify-center p-4 bg-slate-900/80 backdrop-blur-md animate-in fade-in" onClick={() => setShowContentsList(false)}>
          <div className="relative w-full max-w-4xl bg-white dark:bg-slate-900 rounded-[3rem] shadow-2xl overflow-hidden max-h-[85vh] flex flex-col text-right font-sans" onClick={e => e.stopPropagation()}>
            {/* الهيدر */}
            ...
            <div className="p-6 bg-slate-50 border-b grid grid-cols-1 md:grid-cols-3 gap-4 font-sans">
              {/* البحث */}
                    ...
                    <div key={item.id} className="p-5 bg-slate-50 rounded-3xl border flex items-center justify-between flex-row-reverse gap-4 hover:border-blue-500 transition-all">
                      ...
                      <div className="flex gap-2">
                        ...
                        <button 
                          ...
                          className="p-2.5 bg-red-50 text-red-600 hover:bg-red-100 rounded-xl transition-all font-sans"
      ...
      {viewingContent && (
        <div className="fixed inset-0 z-[500] flex flex-col bg-black/95 backdrop-blur-md animate-in fade-in" onClick={() => setViewingContent(null)}>
           <div className="p-6 border-b border-white/10 flex items-center justify-between flex-row-reverse font-sans">
              <div className="flex items-center gap-3">
                <h4 className="font-black text-xl text-white italic font-sans font-sans font-sans">{viewingContent.title}</h4>
              </div>
              <div className="flex gap-2 font-sans font-sans font-sans font-sans font-sans font-sans font-sans font-sans font-sans">
           ...
           <div className="flex-1 overflow-hidden animate-in fade-in font-sans" onClick={e => e.stopPropagation()}>
              {viewingContent.type === 'video' ? (
                <video src={viewingContent.url} controls className="w-full h-full object-contain font-sans font-sans" autoPlay />
              ) : (
                <div className="w-full h-full flex flex-col items-center justify-center text-white bg-slate-950 p-6 text-center font-sans font-sans font-sans font-sans font-sans font-sans font-sans font-sans font-sans font-sans">
                   <FileText size={64} className="text-amber-500 mb-4 animate-bounce font-sans font-sans font-sans font-sans font-sans font-sans font-sans font-sans" />
                   <h3 className="text-2xl font-black mb-2 font-sans font-sans">الملف أو المذكرة جاهزة للقراءة والتحميل</h3>
      ...
      {completedQuizResult && (
        <div className="fixed inset-0 z-[600] flex items-center justify-center p-4 bg-slate-900/80 backdrop-blur-md animate-in fade-in font-sans font-sans font-sans font-sans" onClick={() => setCompletedQuizResult(null)}>
           <div className="bg-white w-full max-w-md rounded-[3rem] p-8 text-center border shadow-2xl" onClick={e => e.stopPropagation()}>
              <Trophy className="text-amber-500 mx-auto mb-4 animate-bounce font-sans font-sans font-sans font-sans font-sans" size={64} />
              <h3 className="text-2xl font-black mb-2 italic">انتهى الاختبار بنجاح! 🎉</h3>
              <p className="text-sm text-slate-500 dark:text-slate-400 font-bold mb-6 font-sans">لقد تم تسليم وتصحيح اختبارك "{completedQuizResult.title}" بنجاح وتلقائياً.</p>
              
              <div className="bg-slate-50 p-6 rounded-3xl mb-8">
                 <p className="text-xs text-slate-400 font-black mb-1 font-sans">الدرجة النهائية الحاصل عليها:</p>
                 <h4 className="text-4xl font-black text-blue-600 font-sans font-sans font-sans">{completedQuizResult.score}</h4>
                 <p className="text-sm text-blue-600 font-bold mt-2 font-sans">معدل الإجابات الصحيحة: {completedQuizResult.percentage}%</p>
              </div>
